...
from report import HotelManagement
...
class Login_Window:
   def __init__(self,root) :
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\SDT_Zoom-Backgrounds_April-8_Windansea-1-logo-1.jpg")
        ...
        img1=Image.open(r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\LoginIconAppl.png")
        ...
        img2=Image.open(r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\LoginIconAppl.png")
        img2=img2.resize((25,25))
        self.photoimage2=ImageTk.PhotoImage(img2)
        lblimg2=Label(image=self.photoimage2,bg="black",borderwidth=0)
        lblimg2.place(x=650,y=323,width=25,height=25)

        img3=Image.open(r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\lock-512.png")
...
#forgetpassbtn
   ...
   def login(self):
      ...
      elif self.txtuser.get()=="pratham" and self.txtpass.get()=="1234":
   ...
   def forgot_password_window(self):
       if self.txtuser.get()=="":
           ...
           if row==None:
               ...
               l=Label(self.root2,text="Forgot Passord",font=("times new roman",15,"bold"),fg="red",bg="white")
...
#======================background image=========================================
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\0-3450_3d-nature-wallpaper-hd-1080p-free-download-new.jpg")
...
#====================== left image==============================
        ...
        self.bg1=ImageTk.PhotoImage(file=r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\thought-good-morning-messages-LoveSove.jpg")
...
#============= row 4
    ...
    #====================checkbutton====================
        ...
        #===================buttons============================
        img=Image.open(r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\register-now-button1.jpg")
        img=img.resize((200,55))
        self.photoimage=ImageTk.PhotoImage(img)
        b1=Button(frame,image=self.photoimage,command=self.register_data,borderwidth=0,cursor="hand2")
        b1.place(x=10,y=420,width=200)

        img1=Image.open(r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\loginpng.png")
...
#===================function declaration===========================
    def register_data(self):
        if self.var_fname.get()=="" or self.var_email.get()==""or self.var_securityQ.get()=="":
            ...
            conn.commit()
            conn.close()
            messagebox.showinfo("Success","Registed Successfully")
...
#  ==============================first image===========================================
        img1=Image.open(r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\hotel1.png")
...
#===========================title=============================================================
        ...
        #=======================right side image========================================================
        img3=Image.open(r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\slide3.jpg")
        img3=img3.resize((1310,590))
        self.photoimg3=ImageTk.PhotoImage(img3)


        lblimg11=Label(main_frame,image=self.photoimg3,bd=4,relief=RIDGE)
        lblimg11.place(x=225,y=0,width=1310,height=590)
        #===========================down image=======================================================
        img4=Image.open(r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\myh.jpg")
        img4=img4.resize((230,210))
        self.photoimg4=ImageTk.PhotoImage(img4)


        lblimg11=Label(main_frame,image=self.photoimg4,bd=4,relief=RIDGE)
        lblimg11.place(x=0,y=225,width=230,height=210)

        img5=Image.open(r"C:\Users\Pratham Sonigara\Desktop\itvedant\Project\Hotel Management System\Hotel Managment System\images\khana.jpg")
        img5=img5.resize((230,190))
        self.photoimg5=ImageTk.PhotoImage(img5)


        lblimg11=Label(main_frame,image=self.photoimg5,bd=4,relief=RIDGE)
        lblimg11.place(x=0,y=420,width=230,height=190)
    def report(self):
        self.new_window=Toplevel(self.root)
        self.app=HotelManagement(self.new_window)

    def logout(self):
        logout=messagebox.askyesno("YesNo","Are you sure you want to loggout",parent=self.root)
        if logout>0:
            self.root.destroy()
        else:
            if not logout:
